...
describe('Calendar', () => {
  ...
  describe('after render', () => {
    ...
    describe('keyboard works', () => {
      ...
      it('enter to select works', () => {
        ...
        const today = calendar.state().value;
      ...
      it('enter not to select disabled date', () => {
        ...
        calendar = mount(<Calendar onSelect={onSelect} disabledDate={disabledDate} />);
    ...
    it('onSelect works', () => {
      ...
      calendar = mount(<Calendar format={format} showToday onSelect={onSelect} showWeekNumber />);
    ...
    it('extra footer works', () => {
      ...
      calendar = mount(
        <Calendar format={format} showToday showWeekNumber renderFooter={renderFooter} />,
      );
  ...
  describe('input', () => {
    it('change will fire onSelect/onChange', () => {
      ...
      const calendar = mount(
        <Calendar format={format} showToday onSelect={onSelect} onChange={onChange} />,
      );
  ...
  describe('onOk', () => {
    it('triggers onOk', () => {
      ...
      const calendar = mount(<Calendar showOk defaultSelectedValue={selected} onOk={handleOk} />);
