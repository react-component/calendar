	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { className: 'rc-calendar-picker-input', style: { width: 200 }, disabled: state.disabled, placeholder: '请选择日期' })
	        )
	      )
	    );
	  }
